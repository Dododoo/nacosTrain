...
INSERT INTO `menu_info` VALUES (0,'用户管理','127.0.0.1:9001/rbac-service/user/getUserList',0),(1,'用户查询','127.0.0.1:9001/rbac-service/user/getUserList',1),(2,'历史记录','127.0.0.1:9001/rbac-service/user/getHistory',2),(3,'查看主页','127.0.0.1:9001/rbac-service/user/getUser',2);
